...
//                r.getDimensionPixelSize(R.dimen.clingPunchThroughGraphicCenterRadius);
            ...
            mClingStep3 = (ViewGroup) findViewById(R.id.workspace_cling3);
...
//        mHandTouchGraphic = null;
    ...
    private int[] getPunchThroughPosition() {
        if (mDrawIdentifier.equals(WORKSPACE_PORTRAIT)) {
            return new int[]{getMeasuredWidth() - mAppIconSize / 2, getMeasuredHeight() - mAppIconSize / 2};
...
//            mLauncher.getWindowManager().getDefaultDisplay().getMetrics(metrics);
            ...
            if (mBackground == null) {
                if (mDrawIdentifier.equals(WORKSPACE_PORTRAIT) ||
                    mDrawIdentifier.equals(WORKSPACE_LANDSCAPE) ||
                    mDrawIdentifier.equals(WORKSPACE_LARGE)) {
                    if (mClingStep3.getVisibility() != View.VISIBLE) {
                        mBackground = new ColorDrawable(Color.argb(100, 0, 0, 0));
                    } else {
                        mBackground = getResources().getDrawable(R.drawable.screen_overlay_dark_holo);
                    }
                }/* else if (mDrawIdentifier.equals(ALLAPPS_PORTRAIT) ||
                        mDrawIdentifier.equals(ALLAPPS_LANDSCAPE) ||
                        mDrawIdentifier.equals(ALLAPPS_LARGE)) {
                    mBackground = getResources().getDrawable(R.drawable.bg_cling2);
                        ...
                        mDrawIdentifier.equals(FOLDER_LANDSCAPE)) {
                    mBackground = getResources().getDrawable(R.drawable.screen_overlay_light);
                } else if (mDrawIdentifier.equals(FOLDER_LARGE)) {
                    mBackground = getResources().getDrawable(R.drawable.screen_overlay_light);
                }
            } else if (mClingStep3 != null && mClingStep3.getVisibility() == View.VISIBLE) {
                mBackground = getResources().getDrawable(R.drawable.screen_overlay_dark_holo);
            }
