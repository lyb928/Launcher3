...
public class LauncherModel extends BroadcastReceiver {
    ...
    ShortcutInfo infoFromShortcutIntent(Context context, Intent data, Bitmap fallbackIcon) {
        ...
        if (bitmap != null && bitmap instanceof Bitmap) {
            /*
             * FastBitmapDrawable will not scale its bitmap, which is incorrect in shortcut icon creation,
             * we use BitmapDrawable instead.  modify by leeyb
             */
            icon = Utilities.createIconBitmap(new BitmapDrawable((Bitmap)bitmap) {
                @Override
