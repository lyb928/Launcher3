...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    private static final int NUM_ITEMS_IN_PREVIEW_HON = 3;
    private static final int NUM_ITEMS_IN_PREVIEW_VER = 2;
...
//    private static final float INNER_RING_GROWTH_FACTOR = 0.15f;
    ...
    static final float OUTER_RING_GROWTH_FACTOR = 0.3f;
...
//        public static Drawable sSharedOuterFileDrawable = null;
//        public static Drawable sSharedInnerFileDrawable = null;
...
//            mOuterRingDrawable = res.getDrawable(R.drawable.ic_folder/*portal_ring_outer_holo*/);
//            mInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_holo);
            ...
            if (sStaticValuesDirty) {
                ...
                sSharedOuterRingDrawable = res.getDrawable(R.drawable.ic_folder/*portal_ring_outer_holo*/);
//                sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_ring_inner_holo);
//                sSharedFolderLeaveBehind = res.getDrawable(R.drawable.portal_ring_rest);
//                sSharedOuterFileDrawable = res.getDrawable(R.drawable.home_ic_create_folder_focus);
//                sSharedInnerFileDrawable = res.getDrawable(R.drawable.home_ic_create_folder_disable);
        ...
        public void animateToAcceptState() {
            ...
            mAcceptAnimator.setDuration(mIsCreate ? 200 : CONSUMPTION_ANIMATION_DURATION);
...
//                    mInnerRingSize = (1 + percent * INNER_RING_GROWTH_FACTOR) * sPreviewSize;
        ...
        public void animateToNaturalState() {
            ...
            mNeutralAnimator.setDuration(mIsCreate ? 200 : CONSUMPTION_ANIMATION_DURATION);
...
//        }
    ...
    public void onDragEnter(Object dragInfo) {
        ...
        mFolderRingAnimator.mIsCreate = false;
    ...
    private void onDrop(final ShortcutInfo item, View animateView, Rect finalRect,
        ...
        if (animateView != null) {
            ...
            float finalAlpha = index < NUM_ITEMS_IN_PREVIEW_HON * NUM_ITEMS_IN_PREVIEW_VER ? 0.5f : 0f;
...
//            int unscaledHeight = (int) (mIntrinsicIconSize * (1 + PERSPECTIVE_SHIFT_FACTOR));
            mBaselineIconScale = (1.0f * /*adjustedAvailableSpace*/mAvailableSpaceInPreview / mIntrinsicIconSize/*unscaledHeight*/ / 3f);
...
//            mMaxPerspectiveShift = mBaselineIconSize * PERSPECTIVE_SHIFT_FACTOR;
            ...
            mGap = (mAvailableSpaceInPreview - mBaselineIconSize * 3f) / 2f;
        }
    }
...
//        int overlayAlpha;
    ...
    private float getLocalCenterForIndex(int index, int[] center) {
        mParams = computePreviewItemDrawingParams(Math.min(NUM_ITEMS_IN_PREVIEW_HON
                * NUM_ITEMS_IN_PREVIEW_VER, index), mParams);
...
//        index = NUM_ITEMS_IN_PREVIEW_HON * NUM_ITEMS_IN_PREVIEW_VER - index - 1;
//        float r = (index * 1.0f) / (NUM_ITEMS_IN_PREVIEW - 1);
//        float scale = (1 - PERSPECTIVE_SCALE_FACTOR * (1 - r));

//        float offset = (1 - r) * mMaxPerspectiveShift;
//        float scaledSize = scale * mBaselineIconSize;
        int lineIndex = index / NUM_ITEMS_IN_PREVIEW_HON;
        float scaleOffsetCorrection = /*(1 - scale)*/(index % NUM_ITEMS_IN_PREVIEW_HON) * (mBaselineIconSize + mGap)/*mBaselineIconSize*/;
        
        // We want to imagine our coordinates from the bottom left, growing up and to the
        // right. This is natural for the x-axis, but for the y-axis, we have to invert things.
        float transY = (mAvailableSpaceInPreview - mBaselineIconSize * 2f) / 2f + mPreviewOffsetY + lineIndex * (mBaselineIconSize + mGap)/*(offset + scaledSize + scaleOffsetCorrection)*/;
...
//            d.clearColorFilter();
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int nItemsInPreview = Math.min(items.size(), NUM_ITEMS_IN_PREVIEW_HON * NUM_ITEMS_IN_PREVIEW_VER);
        if (!mAnimating) {
