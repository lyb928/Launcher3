...
import com.android.launcher3.DragLayer.DragHolder;
...
public class DragView extends View {
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY,
            int left, int top, int width, int height, View holder) {
        super(launcher);
	...
	public boolean equals(Object o) {
		if (o instanceof DragLayer.DragHolder) {
			DragHolder od = (DragHolder) o;
			return this == od.mDropView;
		}
